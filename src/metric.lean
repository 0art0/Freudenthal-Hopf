-- Source: https://github.com/bottine/mathlib/blob/bottine/combinatorics.simple_graph.metric/some_lemmas/src/combinatorics/simple_graph/metric.lean
...
@[simp] lemma top_mul_left {a : ℕ∞} : ⊤ * a = ⊤ := sorry
